...
1. [kobe_bryant_shot_selection](https://raw.githubusercontent.com/geolamprou/Kobe-Bryant-Shot-Selection-Project/main/data.csv) :The raw file which we clean the data, perform EDA, Inferential statistics and Prediction.
